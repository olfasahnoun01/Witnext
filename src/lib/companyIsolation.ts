...
export const FRONTEND_COMPANY_SCOPED_MODULES: ReadonlyArray<{
  ...
  { path: 'src/services/dbService.ts', requiredMarkers: ['getActiveCompanyId', 'company_id'] },
  { path: 'src/services/productGroupService.ts', requiredMarkers: ['getActiveCompanyId', 'company_id'] },
  { path: 'src/services/documentService.ts', requiredMarkers: ['getActiveCompanyId', 'company_id'] },
  ...
  { path: 'src/components/GestionDevis.tsx', requiredMarkers: ['getActiveCompanyId', 'company_id'] },
  { path: 'src/components/devis/DevisForm.tsx', requiredMarkers: ['getActiveCompanyId', 'company_id'] },
